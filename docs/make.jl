...
deploydocs(;
    repo="github.com/ProjectTorreyPines/EGGO.jl.git",
    target="build",
    branch="gh-pages",
    devbranch="master",
    versions=["stable" => "v^", "v#.#"]
